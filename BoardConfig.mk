...
-include vendor/HASEE/X50TS/BoardConfigVendor.mk

# GPS
TARGET_SPECIFIC_HEADER_PATH := device/HASEE/X50TS/include
...
#TARGET_KERNEL_SOURCE := HASEE/X50TS\
TARGET_PREBUILT_KERNEL := device/HASEE/X50TS/kernel
BOARD_CUSTOM_BOOTIMG_MK := device/HASEE/X50TS/bootimg.mk
BOARD_CUSTOM_BOOTIMG := true

TARGET_KMODULES := true

# Assert
#TARGET_OTA_ASSERT_DEVICE := X50TS,htt92_wet_jb9
...
# EGL
BOARD_EGL_CFG := device/HASEE/X50TS/configs/egl.cfg
...
# RIL
BOARD_RIL_CLASS := ../../../device/HASEE/X50TS/ril/
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/HASEE/X50TS/bluetooth

# Sensors
TARGET_NO_SENSOR_PERMISSION_CHECK := true

# CWM
TARGET_RECOVERY_FSTAB := device/HASEE/X50TS/rootdir/recovery.fstab
