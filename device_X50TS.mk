...
$(call inherit-product-if-exists, vendor/HASEE/X50TS/X50TS-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/HASEE/X50TS/overlay

LOCAL_PATH := device/HASEE/X50TS
